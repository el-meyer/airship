...
tabsetPanel(id = "main", type = "tabs",
            ...
            tabPanel("Plot",
                     sliderInput("line_size", "Choose line size", value = 0.8, min = 0.5, max = 3, step = 0.1),
                     renderPlot(height = 600,{
                       ...
                       validate(
                         need(
                           length(input$OCS) > 0, message = "Choose Operating Characteristics on the left side")
                       )
...
tabPanel("Manual",
         ...
         HTML("Note that Operating Characteristics 'PTP', 'Disj_Power', 'PTT1ER', 'FWER' and 'Avg_PTP_Trial' do not exist in all scenarios."),
         
         h4("Change default values:"),
         
         HTML("Checking the checkbox at the bottom of the sidebar displays another tab in the sidebar where you can specify the values for the simulation scenario you want to investigate. One by one you can choose the variable and corresponding value."),
         
         h4("Outputs"),
         HTML("In the main Panel there are three tabs. The first two visualize the configurated scenario, one of them having an interactive feature. The third one shows Table of the results for the configurated simulation scenario")
